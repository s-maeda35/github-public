"""
Django settings for dmd_app project.
...
SECRET_KEY = 'django-insecure-wmb3ej#$=m32jxr+*+wadmz(ueh)u$ayyn-vczc@yhp%ludumv'
...
ROOT_URLCONF = 'dmd_app.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'dmd_gui', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dmd_app.wsgi.application'
